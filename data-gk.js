...
{id:"days", n:"Important days", hy:1,
 w:"Every national and international day worth learning, month by month.",
 intro:"Learn these by the reason rather than the date where you can \u2014 National Science Day is the day Raman announced his effect, Teachers' Day is Radhakrishnan's birthday, National Mathematics Day is Ramanujan's, World Rabies Day is the day Pasteur died. The reason is what makes the date stick. Where two days fall on the same date, both are given, because either can be the one asked.",
 blocks:[
  {h:"January",
   rows:[
    ...
    ["10 January","World Hindi Day. Not the same as Hindi Diwas, which is 14 September"],
    ...
    ["26 January","Republic Day \u2014 the Constitution came into force in 1950"],
  ...
  {h:"March",
   rows:[
    ...
    ["15 March","World Consumer Rights Day. India's own National Consumer Day is 24 December"],
  ...
  {h:"April",
   rows:[
    ...
    ["14 April","Ambedkar Jayanti \u2014 his birthday, in 1891"],
  ...
  {h:"July",
   rows:[
    ...
    ["28 July","World Hepatitis Day, and World Nature Conservation Day \u2014 both fall on this date"],
    ["29 July","International Tiger Day"]
   ]},
  {h:"August",
   rows:[
    ["6 August","Hiroshima Day"],
    ["9 August","Quit India Movement Day, and Nagasaki Day"],
    ["12 August","International Youth Day"],
    ["15 August","Independence Day"],
    ["19 August","World Humanitarian Day"],
    ["20 August","Sadbhavana Diwas \u2014 Rajiv Gandhi's birthday"],
  ...
  {h:"September",
   rows:[
    ...
    ["28 September","World Rabies Day \u2014 the anniversary of Louis Pasteur's death"]
   ]},
  {h:"October",
   rows:[
  ...
  {h:"November",
   rows:[
    ...
    ["20 November","Universal Children's Day \u2014 the international one, as against India's on the 14th"],
    ["26 November","Constitution Day, and National Law Day \u2014 the Constitution was adopted in 1949"]
   ]},
  {h:"December",
   rows:[
    ["1 December","World AIDS Day"],
    ["2 December","National Pollution Control Day \u2014 it marks the Bhopal gas tragedy of 1984"],
    ...
    ["16 December","Vijay Diwas \u2014 the 1971 victory"],
    ["22 December","National Mathematics Day \u2014 Ramanujan's birthday"],
    ["23 December","Kisan Diwas, or National Farmers' Day \u2014 Charan Singh's birthday"],
    ["24 December","National Consumer Day"],
    ["25 December","Good Governance Day \u2014 Vajpayee's birthday"]
   ]},
  {h:"The month anchors",
   note:"One chain per month. Recite the chain and the individual dates come back with it.",
   rows:[
    ["January","Youth, Army, Voters, Republic, Martyrs"],
    ["February","Science"],
    ["March","Women, Forests, Water, Weather, TB"],
    ["April","Health, Ambedkar, Earth, Books, Panchayat, Malaria"],
    ["May","Labour, Technology, Families, Biodiversity, Tobacco"],
    ["June","Environment, Blood, Yoga"],
    ["July","Population, Kargil, Hepatitis, Tiger"],
    ["August","Quit India, Youth, Independence, Sports"],
    ["September","Teachers, Hindi, Engineers, Ozone, Peace, Tourism"],
    ["October","Gandhi, Air Force, Food, United Nations, Unity"],
    ["November","Education, Children, Constitution"],
    ["December","AIDS, Navy, Human Rights, Mathematics, Farmers"]
   ]},
  {h:"If time runs out, these thirty-five",
   note:"The shortlist, in calendar order.",
   rows:[
  ...
  {h:"How a day is actually asked",
   rows:[
    ["The four parts","The date, the exact name, whether it is national or international, and the person or event behind it"],
    ["Why the exact name matters","World Consumer Rights Day is 15 March and international; National Consumer Day is 24 December and India's own. One word separates them"],
    ["The other pairs built the same way","World Hindi Day on 10 January against Hindi Diwas on 14 September; Children's Day on 14 November against Universal Children's Day on 20 November"]
   ]}
 ]},
